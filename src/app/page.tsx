...
export default async function Home() {
  ...
  return (
    <>
      <h1 className="font-bold text-3xl text-slate-50 md:text-4xl">
        Your feed
      </h1>
      <div className="grid grid-cols-1  md:grid-cols-3 gap-y-4 md:gap-x-4 py-6">
        ...
        {/* subreddit info */}
        <div className="overflow-hidden h-fit rounded-lg border bg-slate-800 border-gray-600 order-first md:order-last">
